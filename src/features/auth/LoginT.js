        ...
        <section className="min-h-screen flex items-center justify-center bg-cover bg-center relative" dir='rtl' style={{backgroundImage: 'url("../bgtotal.png")'}} >
         <div className="w-full max-w-md">
                <header className="mb-4">
                    <h1 className="text-3xl text-white font-bold text-center">تسجيل الدخول للأساتذة</h1>
                </header>
            ...
            <button
                className="bg-blue-500 hover:bg-blue-700 mt-5 text-2xl text-white font-bold py-2 px-9 rounded focus:outline-none focus:shadow-outline"
