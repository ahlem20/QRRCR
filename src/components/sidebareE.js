...
const SidebarE = () => {
  const menus = [
       { name: 'الصفحة الرئيسية', link: '/dashE/', icon: <HiOutlineHome size={30} /> },
    { name: 'إنشاء رمز الاستجابة السريعة', link: '/dashE/qreniratore', icon: <HiHashtag size={30} />, margin: true },
    { name: 'مراجعي', link: '/dashE/myqrs', icon: <AiFillFolderOpen size={30} /> },
    { name: 'تقيماتي', link: '/dashE/mynotes', icon: <HiOutlineDocumentText size={30} /> },
